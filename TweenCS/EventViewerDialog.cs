        ...
        private void SaveLogButton_Click(object sender, EventArgs e)
        {
            ...
            switch (rslt)
            {
                case DialogResult.Yes:
                    SaveFileDialog1.FileName = "TweenEvents" + _curTab.Tag.ToString() + DateTime.Now.ToString("yyMMdd-HHmmss") + ".tsv";
                    break;
                case DialogResult.No:
                    SaveFileDialog1.FileName = "TweenEvents" + DateTime.Now.ToString("yyMMdd-HHmmss") + ".tsv";
                    break;
                default:
                    return;
            }
