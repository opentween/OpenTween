...
namespace Tween
{
    public partial class TweenMain : Form
    {
        ...
        //Growl呼び出し部
        private GrowlHelper gh = new GrowlHelper("Tween");
                    ...
                    if (SettingDialog.IsNotifyUseGrowl)
                    {
                        ...
                        foreach (PostClass post in notifyPosts)
                        {
                            ...
                            if (dm)
                            {
                                ...
                                //NotifyIcon1.BalloonTipTitle += "Tween [DM] " + Properties.Resources.RefreshDirectMessageText1 + " " + addCount.ToString() + Properties.Resources.RefreshDirectMessageText2;
                            ...
                            {
                                //NotifyIcon1.BalloonTipIcon = ToolTipIcon.Warning;
                                //NotifyIcon1.BalloonTipTitle += "Tween [Reply!] " + Properties.Resources.RefreshTimelineText1 + " " + addCount.ToString() + Properties.Resources.RefreshTimelineText2;
                                ntIcon = ToolTipIcon.Warning;
                            ...
                            else
                            {
                                ...
                                //NotifyIcon1.BalloonTipTitle += "Tween " + Properties.Resources.RefreshTimelineText1 + " " + addCount.ToString() + Properties.Resources.RefreshTimelineText2;
    ...
    RETRY:
        ...
        private void SaveLogMenuItem_Click(object sender, EventArgs e)
        {
            ...
            SaveFileDialog1.FileName = "TweenPosts" + DateTime.Now.ToString("yyMMdd-HHmmss") + ".tsv";
...
#region "Userstream"
        ...
        private void NotifyEvent(Twitter.FormattedEvent ev)
        {
            ...
            if (BalloonRequired(ev))
            {
                NotifyIcon1.BalloonTipIcon = ToolTipIcon.Warning;
                //if (SettingDialog.DispUsername) NotifyIcon1.BalloonTipTitle = tw.Username + " - "; else NotifyIcon1.BalloonTipTitle = "";
                //NotifyIcon1.BalloonTipTitle += "Tween [" + ev.Event.ToUpper() + "] by " + ((string)(!string.IsNullOrEmpty(ev.Username) ? ev.Username : ""), string);
                StringBuilder title = new StringBuilder();
                if (SettingDialog.DispUsername)
                {
                    title.Append(tw.Username);
