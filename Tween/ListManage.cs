...
namespace Tween
{
    public partial class ListManage : Form
    {
        ...
        private void DeleteUserButton_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show(Properties.Resources.ListManageDeleteUser1, "Tween", MessageBoxButtons.OKCancel) == DialogResult.OK)
            {
        ...
        private void DeleteListButton_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show(Properties.Resources.ListManageDeleteLists1, "Tween", MessageBoxButtons.OKCancel) == DialogResult.OK)
            {
                string rslt = "";
